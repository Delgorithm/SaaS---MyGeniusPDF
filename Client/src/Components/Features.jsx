    ...
    <main>
      <section>
        <div className='flex flex-col items-center align-center'>
          <h2 className='bg-gradient-to-l from-[#8B7EFF] to-[#9F54FF] text-transparent bg-clip-text text-4xl'>Features</h2>
          ...
          <picture className='relative flex flex-col items-center -z-50 -top-24'>
            <img src="./Img/MacAndIphone.svg" alt="MacBookPro16' and iPhone 15" className=''/>
          </picture>
          ...
          <div className='grid grid-cols-3 grid-rows-2 gap-4 relative -top-40'>
            ...
            <div className='flex flex-col items-center justify-center gap-3'>
              <img src="./Img/IconIA.svg" alt="Icon Discussion" />
            ...
            <div className='flex flex-col items-center justify-center gap-3'>
              <img src="./Img/IconChat.svg" alt="Icon Discussion" />
            ...
            <div className='flex flex-col items-center justify-center gap-3'>
              <img src="./Img/IconPower.svg" alt="Icon Discussion" />
            ...
            <div className='flex flex-col items-center justify-center gap-3'>
              <img src="./Img/IconCloud.svg" alt="Icon Discussion" />
